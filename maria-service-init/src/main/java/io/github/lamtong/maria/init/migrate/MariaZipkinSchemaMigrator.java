...
/**
 * {@code Maria-Web} 依赖的链路追踪展示服务 {@code Zipkin} 迁移类.
 *
 * @author Lam Tong
 * @version 0.0.1
 * @see SchemaMigrator
 ...
 * @since 0.0.1
 */
public class MariaZipkinSchemaMigrator implements SchemaMigrator, SchemaNameProvider {

    private static final Logger logger = LoggerFactory.getLogger(MariaZipkinSchemaMigrator.class);

    private static final String SCHEMA_NAME = "maria_zipkin";

    private static final String DB_LOCATION = "maria/zipkin";
