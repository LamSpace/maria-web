...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) {
        web.ignoring()
                .antMatchers(ServiceSystem.ModuleUser.URL_ROLE_ID_BY_USERNAME_VALUE)
                .antMatchers(ServiceSystem.ModuleUser.URL_FIND_BY_USERNAME_VALUE)
                .antMatchers(ServiceSystem.ModuleRole.URL_MENU_IDS_BY_ROLE_IDS_VALUE)
                .antMatchers(ServiceSystem.ModuleMenu.URL_GET_ALL_MENUS_VALUE)
                .antMatchers(ServiceSystem.ModuleMenu.URL_MENUS_BY_IDS_VALUE)
